...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    meta: {
      modelProps: 'post' | 'banner' | 'order' | 'under' | 'deal'
    ...
    model: {
      ...
      Deal: {
        ...
        operations: {
          ...
          findRaw: {
            args: Prisma.DealFindRawArgs<ExtArgs>,
            result: Prisma.JsonObject
          }
          aggregateRaw: {
            args: Prisma.DealAggregateRawArgs<ExtArgs>,
            result: Prisma.JsonObject
          }
          count: {
  ...
  export interface DealDelegate<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> {
    ...
    **/
    ...
    /**
     * Find zero or more Deals that matches the filter.
     * @param {DealFindRawArgs} args - Select which filters you would like to apply.
     * @example
     * const deal = await prisma.deal.findRaw({
     *   filter: { age: { $gt: 25 } } 
     * })
    **/
    findRaw(
      args?: DealFindRawArgs
    ): Prisma.PrismaPromise<JsonObject>

    /**
     * Perform aggregation operations on a Deal.
     * @param {DealAggregateRawArgs} args - Select which aggregations you would like to apply.
     * @example
     * const deal = await prisma.deal.aggregateRaw({
     *   pipeline: [
     *     { $match: { status: "registered" } },
     *     { $group: { _id: "$country", total: { $sum: 1 } } }
     *   ]
  ...
  interface DealFieldRefs {
    ...
    readonly img: FieldRef<"Deal", 'String[]'>
  }
   ...
   * Deal findRaw
   */
  export type DealFindRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * The query predicate filter. If unspecified, then all documents in the collection will match the predicate. ${@link https://docs.mongodb.com/manual/reference/operator/query MongoDB Docs}.
     */
    filter?: InputJsonValue
   ...
   * Deal aggregateRaw
   */
  export type DealAggregateRawArgs<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = {
    /**
     * An array of aggregation stages to process and transform the document stream via the aggregation pipeline. ${@link https://docs.mongodb.com/manual/reference/operator/aggregation-pipeline MongoDB Docs}.
     */
    pipeline?: InputJsonValue[]
  ...
  export type DealWhereInput = {
    ...
    img?: StringNullableListFilter<"Deal">
  }
  ...
  export type DealCreateimgInput = {
    set: string[]
  }

  export type DealUpdateimgInput = {
    set?: string[]
    push?: string | string[]
  }
