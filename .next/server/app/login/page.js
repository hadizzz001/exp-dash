...
/* harmony import */ var next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12___default = /*#__PURE__*/__webpack_require__.n(next_dist_server_app_render_rsc_preloads__WEBPACK_IMPORTED_MODULE_12__);
    ...
    const tree = {
        ...
        {
        children: ['__PAGE__', {}, {
          page: [() => Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 7630)), "C:\\Users\\abc\\Desktop\\Hadi\\My Bussiness\\Si bon\\web - dash\\app\\login\\page.tsx"],
    ...
    const pages = ["C:\\Users\\abc\\Desktop\\Hadi\\My Bussiness\\Si bon\\web - dash\\app\\login\\page.tsx"];
...
Promise.resolve(/* import() eager */).then(__webpack_require__.bind(__webpack_require__, 42392))
...
/* harmony import */ var jquery__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(48051);
...
const login = ()=>{
    ...
    async function handleEditSubmit() {
        axios__WEBPACK_IMPORTED_MODULE_4__/* ["default"] */ .Z.patch(`/api/login/6541366999820c954845b8a8`, tabID).then((res)=>{
            console.log(res);
        }).catch((err)=>{
            console.log("Error");
            console.log(err);
...
const proxy = (0,next_dist_build_webpack_loaders_next_flight_loader_module_proxy__WEBPACK_IMPORTED_MODULE_0__.createProxy)(String.raw`C:\Users\abc\Desktop\Hadi\My Bussiness\Si bon\web - dash\app\login\page.tsx`)
...
var __webpack_exports__ = __webpack_require__.X(0, [381,899,813,51,358], () => (__webpack_exec__(73212)));
